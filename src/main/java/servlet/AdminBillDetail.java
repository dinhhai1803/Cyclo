 ...
 * @author win
 */
@WebServlet(name = "AdminBillDetail", urlPatterns = {"/AdminBillDetail"})
public class AdminBillDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("Admin/DetailBill/AdminBillDetail.jsp");
    }
