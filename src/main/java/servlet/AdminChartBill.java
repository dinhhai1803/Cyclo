 ...
 * @author win
 */
@WebServlet(name = "AdminChartBill", urlPatterns = {"/AdminChartBill"})
public class AdminChartBill extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, ParseException, com.nimbusds.oauth2.sdk.ParseException {

        BillDAO dao = new BillDAO();
        ArrayList<Bill> b = dao.getAllBill();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AdminChartBill.class.getName()).log(Level.SEVERE, null, ex);
